# Copy the ENTIRE Flask backend code from the first artifact I created
# It starts with "# app.py - Main Flask application" 
# and ends with "app.run(debug=True, host='0.0.0.0', port=5000)"
...
def scrape_urls_background(job_id, urls):
    ...
    scraper = ProductScraper(delay=3)
...
# Initialize database - Updated for newer Flask
def create_tables():
